...
const EmmaEa26 = sequelize.define('EmmaEa26', {
  id: {
...
EmmaEa26.belongsTo(Upload, { foreignKey: 'id_cargas' });
EmmaEa26.belongsTo(Clasification, { foreignKey: 'id_clasificacion' });

module.exports = { EmmaEa26 };
